...
public class SpecialJsonConverter extends CardJsonConverter {
    ...
    public Special convertFromJsonObject(JSONObject jsonSpecial) {
        ...
        return createSpecial(name, description, type);
    }
    ...
    private Special createSpecial(String name, String description, String type) {
        switch (type) {
            ...
            case "Clima":
                return weatherConverter.createWeatherCard(name, description);
            default:
